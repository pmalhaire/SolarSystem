...
public:
  ...
  unsigned int getNormalCount() const {
    return static_cast<unsigned int>(normals.size() / 3);
  }
  unsigned int getTexCoordCount() const {
    return static_cast<unsigned int>(texCoords.size() / 2);
  }
  unsigned int getIndexCount() const {
    return static_cast<unsigned int>(indices.size());
  }
  unsigned int getLineIndexCount() const {
    return static_cast<unsigned int>(lineIndices.size());
  }
  ...
  unsigned int getNormalSize() const {
    return static_cast<unsigned int>(normals.size() * sizeof(float));
  }
  unsigned int getTexCoordSize() const {
    return static_cast<unsigned int>(texCoords.size() * sizeof(float));
  }
  unsigned int getIndexSize() const {
    return static_cast<unsigned int>(indices.size() * sizeof(unsigned int));
  }
  unsigned int getLineIndexSize() const {
    return static_cast<unsigned int>(lineIndices.size() * sizeof(unsigned int));
  }
  ...
  unsigned int getInterleavedVertexSize() const {
    return static_cast<unsigned int>(interleavedVertices.size() *
                                     sizeof(float));
  } // # of bytes
